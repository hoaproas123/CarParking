        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            DbContextOptions<CarParkingContext>>()))
            {
                ...
                new KhachHang
                {
                    Id = 1,
                    MaXe = "99H-5678",
                    timeIn = DateTime.Parse("20/10/2020"),
                    timeOut = DateTime.Parse("21/10/2020"),
                    BaiXe_Id = 1,
                    Total= 72000
                },
                new KhachHang
                {
                    Id = 2,
                    MaXe = "66F-64326",
                    timeIn = DateTime.Parse("22/11/2020"),
                    timeOut = DateTime.Parse("3:15:30 22/11/2020"),
                    BaiXe_Id = 1,
                    Total = 90000
                },
                new KhachHang
                {
                    Id = 3,
                    MaXe = "65U-64126",
                    timeIn = DateTime.Parse("22/03/2020"),
                    timeOut = DateTime.Parse("22/04/2020"),
                    BaiXe_Id = 2,
                    Total = 14600000
                },
                new KhachHang
                {
                    Id = 4,
                    MaXe = "12Y-12453",
                    timeIn = DateTime.Parse("12:30:24 22/03/2023"),
                    timeOut = DateTime.Parse("07:32:25 23/03/2023"),
                    BaiXe_Id = 3,
                    Total = 228000
                }
                );
