...
namespace CarParking.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Password,Role")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Password,Role")] Account account)
        {
            if (id != account.Id)
            {
                return NotFound();
